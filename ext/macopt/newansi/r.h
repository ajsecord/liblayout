/*   r.h         header for assorted minor subroutines library          release 1.1    
    ...
    http://www.inference.phy.cam.ac.uk/mackay/       mackay@mrao.cam.ac.uk
*/
/*	ANSI Version 1 	*/
/* 9 6 92 */
...
/* void   srandom ( long ) ; */  /* commented out 980928 for DEC */
long    random ( void ) ;   /* Changed from int to match BSD/OS X by AJS */
/*
double	drand48( ) ;
void 	srand48( long ) ;
int 	abs( int ) ; 
...
double digamma_dif ( double s , double c , int ) ;
